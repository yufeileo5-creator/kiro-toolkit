...
### 按场景加载
- 修改 import/新增模块 → 架构准则（GR-A001~A009）
- 每次代码修改 → 代码质量准则（GR-Q001~Q009）
- 功能完成后 → 文档准则（GR-D001~D012），配合 `#doc-sync-check`
- 文件/API 操作 → 安全准则（GR-S001~S007）
- 遇到已知错误 → 错误自修复提示
